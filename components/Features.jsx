    ...
    <section className="bg-black pb-52">
      <div className="container mx-auto px-3 md:px-10">
        <div className="px-5 py-32">
          <p className="font-circulat-web text-lg text-blue-50">
            Into the Meta-layer
          </p>
          <p className="max-w-md font-circulat-web text-lg text-blue-50 opacity-50">
        ...
        <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-hidden rounded-md md:h-[65vh]">
          <BentoCard
            ...
            description="A cross-platform, AI-driven, gamified, and hyper-personalized experience that rewards users for their attention and engagement."
            isComingSoon={true}
          />
        </BentoTilt>
        <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
          ...
          <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
            <BentoCard
              ...
              description="A cross-world AI Agent that learns from user behavior and rewards users for their attention and engagement."
            />
          </BentoTilt>
          <BentoTilt className="bent-tilt_2">
                <div className="flex size-full flex-col justify-between bg-violet-300 p-5">
                <h1 className="special-font bento-title max-w-64 text-black">M<b>o</b>re co<b>m</b>ing so<b>o</b>n!</h1>
    ...
    <div className="relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col justify-between p-5 text-blue-50">
        <div>
          ...
          {description && (
            <p className="mt-3 max-w64 text-xs md:text-base">{description}</p>
          )}
        </div>
      </div>
    </div>
